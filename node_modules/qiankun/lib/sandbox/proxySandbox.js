...
var cachedGlobals = Array.from(new Set(_without2.default.apply(void 0, [_globals.globals.concat(overwrittenGlobals).concat('requestAnimationFrame')].concat(accessingSpiedGlobals))));
// transform cachedGlobals to object for faster element check
exports.cachedGlobals = cachedGlobals;
var cachedGlobalObjects = cachedGlobals.reduce(function (acc, globalProp) {
  return (0, _objectSpread4.default)((0, _objectSpread4.default)({}, acc), {}, (0, _defineProperty2.default)({}, globalProp, true));
}, {});
/*
 ...
 */
var unscopables = _without2.default.apply(void 0, [cachedGlobals].concat((0, _toConsumableArray2.default)(accessingSpiedGlobals.concat(overwrittenGlobals)))).reduce(function (acc, key) {
  return (0, _objectSpread4.default)((0, _objectSpread4.default)({}, acc), {}, (0, _defineProperty2.default)({}, key, true));
},
