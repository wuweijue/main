...
export var cachedGlobals = Array.from(new Set(_without.apply(void 0, [globals.concat(overwrittenGlobals).concat('requestAnimationFrame')].concat(accessingSpiedGlobals))));
