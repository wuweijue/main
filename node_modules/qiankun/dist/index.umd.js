(function (global, factory) {
	...
	var cachedGlobals = Array.from(new Set(without_1.apply(void 0, [globals.concat(overwrittenGlobals).concat('requestAnimationFrame')].concat(accessingSpiedGlobals))));
	 ...
	 */
	var unscopables = without_1.apply(void 0, [cachedGlobals].concat(_toConsumableArray(accessingSpiedGlobals.concat(overwrittenGlobals)))).reduce(function (acc, key) {
	    ...
	    var proxyDocument = new Proxy(document, {
	      ...
	      get: function get(target, p, receiver) {
	        switch (p) {
	          ...
	          case 'querySelector':
	            {
	              var targetQuerySelector = target.querySelector;
